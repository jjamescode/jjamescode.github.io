...
- a. Set Variables
Settings > CI/CD > Expand Variables > Add Variable. Add the details of the computer only user. The variables must be named exactly as below as they will be called upon later. 
...
- Turn on masked. It masks the variable in the CI/CD output and not visible in console logs. (/images/6-Create-Variable.PNG)

- b. Create a second variable called AWS_SECRET_ACCESS_KEY
...
0.0.0.0:8080
```
![alt text](/image/docker-success-time.PNG)
...
![alt text](/image/3a-gitlab-merge-push-stage-processing-edit.PNG)
...
![alt text](/images/4a-merge-stages-success_LI-ed.PNG)

16. Review Job in ECR Repository
See ![alt text](/images/5c-ecr-release-success.PNG)
...
![alt text](/images/5c-ecr-release-success_LI-ed.PNG)
